...
static const char *fonts[] = {
    "MartianMono NF:style=Bold:size=11:antialias=true:autohint=true"
};
...
static const Key keys[] = {
    ...
    /* Rotate focused client into master */
    { MODKEY,                       XK_r,          zoom,           {0} },
    ...
    { 0, XK_ISO_Next_Group,
        spawn, SHCMD("pkill -RTMIN+10 dwmblocks") },
