...
{
	[DEFAULT_TAGS]        = { "0-c-comm", "1-e-emacs", "2-x-pass", "3-g-web-mail", "4-w-work", "5-v-video", "6-z-photos", "7-a-audio", "8-s-system" },
