...
{
        [DEFAULT_TAGS]        = { "0-c-comm", "1-e-emacs", "2-x-pass", "3-g-web", "4-w-work", "5-v-video", "6-z-photos", "7-a-audio", "8-r-emailss", "9-s-system" },
...
static const Rule rules[] = {
	 ...
	 * ex:  :xprop | grep WM_CLASS
	 *
         * how to use:
         * use xprop WM_CLASS in terminal and choose the softwere that you whant./
	...
	/*RULE(.class = "Tor Browser Alpha", .tags = 1 << 3)
	/*WM_CLASS(STRING) = "Navigator", "Tor Browser Alpha"*/
	
        RULE(.class = "firefox", .tags = 1 << 3)
        /*WM_CLASS(STRING) = "Navigator", "firefox"*/		

       	RULE(.class = "librewolf", .tags = 1 << 3)
	/*WM_CLASS(STRING) = "Navigator", "librewolf"*/


	/*RULE(.class = "grayjay", .tags = 1 << 5)*/
	/*WM_CLASS(STRING) = "grayjay", "Grayjay"*/


	/*RULE(.class = "Darktable", .tags = 1 << 6)
        /*WM_CLASS(STRING) = "darktable", "Darktable"*/
	

	/*RULE(.class = "FreeTube", .tags = 1 << 7)*/
	/*WM_CLASS(STRING) = "freetube", "FreeTube"*/


	RULE(.class = "Chromium", .tags = 1 << 8)
        /*WM_CLASS(STRING) = "chromium", "Chromium"*/

	RULE(.class = "Mullvad Browser", .tags = 1 << 8)
        /*WM_CLASS(STRING) = "Navigator", "Mullvad Browser"*/

	/*RULE(.class = "Xfce4-terminal", .tags = 1 << 8)
	/*WM_CLASS(STRING) = "xfce4-terminal", "Xfce4-terminal"*/

	/*RULE(.class = "pavucontrol", .tags = 1 << 8)
	/*WM_CLASS(STRING) = "pavucontrol", "pavucontrol"*/
	

        RULE(.class = "kitty", .tags = 1 << 9)
...
static const char *floatingbrowser[] = { "/usr/bin/brave-browser", NULL };
...
static const Key keys[] = {
	...
	/*left hand on keyboard*/
        { MODKEY,                       XK_t,          spawn,                  {.v = termcmd } }, /*spawn a new terminal window*/

	{ MODKEY,                       XK_q,          killclient,             {0} }, /*quit program*/
	{ MODKEY|ShiftMask,             XK_q,          quit,                   {0} }, /*normal quit (dwm exits).*/

	{ MODKEY|ShiftMask,             XK_r,          quit,                   {1} }, /*restart dwm (using restart dwm patch)*/
	...
	{ MODKEY,                       XK_j,          focusstack,             {.i = +1 } }, /*selects clockwise window*/
	{ MODKEY,                       XK_k,          focusstack,             {.i = -1 } }, /*selects counter-clockwise window*/


	{ MODKEY,                       XK_h,          setmfact,               {.f = -0.05} },/*increases window size*/
	{ MODKEY,                       XK_l,          setmfact,               {.f = +0.05} },/*decrease window size*/
	
/*-------------------------------------------------------------------------------------------------------------------------------------------------------------------*/	

	{ MODKEY|ShiftMask,             XK_Return,     zoom,                   {0} }, /*selected window placed on main screen*/

/*      { MODKEY,                       XK_b,          togglebar,              {0} }, /*toggles manue bar on/off*/

	{ MODKEY,                       XK_Tab,        view,                   {0} }, /*changes to previous tag viwed*/
...
/*	{ MODKEY|Mod4Mask,              XK_u,          incrgaps,               {.i = +1 } },
	...
	{ MODKEY|Mod4Mask|ShiftMask,    XK_0,          defaultgaps,            {0} },*/
     ...
     /*	{ MODKEY|ControlMask,           XK_z,          showhideclient,         {0} }, */ /*Mod + Ctrl + Z to call the function showhideclient - hides the selected window*/ 
	...
	{ MODKEY|ShiftMask,             XK_space,      togglefloating,         {0} }, /*makes selected window flowting*/
