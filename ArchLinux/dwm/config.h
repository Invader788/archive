...
static const char *fonts[] = {
    "MartianMono Nerd Font:style=Bold:size=12"
};
...
/* =========================
 * COLORS (Uniform Ghost Bar)
 * ========================= */

static const char col_bg[]      = "#000000";
static const char col_bg2[]     = "#000000";

/* SAME TEXT COLOR EVERYWHERE */
static const char col_fg[]      = "#ffffff";

/* keep border slightly different ONLY for focus hint */
static const char col_border[]  = "#1C222B";

/* accent is NOT used for text changes anymore */
static const char col_accent[]  = "#1C222B";
